...
#include "GA_TwinSword_SecondaryCombo.generated.h"

UCLASS()
class RIFTWARD_API UGA_TwinSword_SecondaryCombo : public UGA_TwinSword_MeleeComboBase
{
	GENERATED_BODY()

public:
	UGA_TwinSword_SecondaryCombo();
