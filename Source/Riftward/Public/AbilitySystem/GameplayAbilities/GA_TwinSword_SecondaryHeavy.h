...
#include "GA_TwinSword_SecondaryHeavy.generated.h"

UCLASS()
class RIFTWARD_API UGA_TwinSword_SecondaryHeavy : public UGA_TwinSword_MeleeComboBase
{
	GENERATED_BODY()

public:
	UGA_TwinSword_SecondaryHeavy();
